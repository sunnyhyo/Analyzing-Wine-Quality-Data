...
table(rw$quality)
#
ggplot(rw)+geom_histogram(aes(fixed.acidity),binwidth=0.5)+
  ggtitle("Fixed Acidity distribution") +
  xlab("Fixed Acidity") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(chlorides),binwidth=0.02)+
  ggtitle("Chlorides") +
  xlab("Chlorides") +
...
names(rw)
ggplot(rw)+geom_histogram(aes(pH),binwidth=0.05)+
  ggtitle("pH") +
  xlab("pH") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(citric.acid))+
  ggtitle("citric acid") +
  xlab("citric acid") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(density))+
  ggtitle("density") +
  xlab("density") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(fixed.acidity))+
  ggtitle("density") +
  xlab("density") +
  ylab("Count")

ggplot(rw)+geom_histogram(aes(total.sulfur.dioxide))+
  ggtitle("Total sulfur dioxide") +
  xlab("Total sulfur dioxide") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(free.sulfur.dioxide))+
  ggtitle("Free sulfur dioxide") +
  xlab("Free sulfur dioxide") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(volatile.acidity))+
  ggtitle("Volatile acidity") +
  xlab("Volatile acidity") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(sulphates))+
  ggtitle("sulphates") +
  xlab("sulphates") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(residual.sugar))+
#  scale_x_log10(breaks = seq(0, 1.6, by = 0.5)) +
#  ggtitle("log(Residual sugar)") +
  ggtitle("Residual sugar") +
  xlab("Residual sugar") +
  ylab("Count")
ggplot(rw)+geom_histogram(aes(alcohol))+
  ggtitle("alcohol") +
  xlab("alcohol") +
  ylab("Count")
